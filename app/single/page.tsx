      ...
      <div className="bg-gray-900 text-white border border-gray-800 rounded-xl bg-gradient-to-b from-transparent to-gray-900 overflow-hidden p-7 max-w-md w-full relative">
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex flex-col">
            ...
            <input className="shadow border rounded py-2 px-3 text-gray-900 focus:outline-none focus:shadow-outline" id="receiver" type="text" placeholder="Address" value={""} />
          </div>
          <div className="flex flex-col md:flex-row md:space-x-4">
            <div className="w-full md:w-1/2 flex flex-col">
              <label className="ml-2 mb-1 font-medium" htmlFor="token">Flux Token</label>
              <div className="relative">
                <select className="block appearance-none w-full bg-black border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="token">
          ...
          <div className="flex flex-col">
            ...
            <input className="shadow border rounded py-2 px-3 text-gray-900 focus:outline-none focus:shadow-outline" id="receiver" type="text" placeholder="Duration in Seconds" value={""} />
          </div>
          <div className="flex items-center justify-end">
            <div className="text-gray-700 text-lg font-bold mr-2">/ second</div>
          </div>
          <div className="flex items-center justify-center mt-4">
            <button className="bg-green-500 text-white font-bold py-2 px-4 rounded" onClick={handleStream}>Send Stream</button>
          </div>
        </div>
      </div>
    </div>
