...
const testimonial = () => {
  ...
  return (
    <section className="testimonial-section font-product -mt-5">
      <div className="testimonial-cards">
        <div className="mx-auto  md:container px-4 sm:px-6 sm:py-24 lg:mr-0 lg:pl-8 lg:pr-0 max-sm:py-4">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16">
            <div className="max-w-xl text-center  sm:text-left">
              ...
              <p className="mt-4 text-violet-600 font-medium">
                Flux Stream is Best Pay Model Ever
              </p>
